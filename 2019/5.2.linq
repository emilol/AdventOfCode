...
int? Run(int[] memory, int programInput)
{
	...
	operations[3] = Input;
	operations[4] = Output;
	operations[5] = JumpIfTrue;
	operations[6] = JumpIfFalse;
	operations[7] = LessThan;
	operations[8] = Equals;
...
public void JumpIfTrue(int[] memory, ref int pointer, int opCode, int input, ref int? output)
{
	var parameter1 = Read(memory, pointer, 1, GetMode(opCode, 1));
	var parameter2 = Read(memory, pointer, 2, GetMode(opCode, 2));
...
public void JumpIfFalse(int[] memory, ref int pointer, int opCode, int input, ref int? output)
{
	var parameter1 = Read(memory, pointer, 1, GetMode(opCode, 1));
	var parameter2 = Read(memory, pointer, 2, GetMode(opCode, 2));
...
public void LessThan(int[] memory, ref int pointer, int opCode, int input, ref int? output)
{
	var parameter1 = Read(memory, pointer, 1, GetMode(opCode, 1));
	var parameter2 = Read(memory, pointer, 2, GetMode(opCode, 2));
...
public void Equals(int[] memory, ref int pointer, int opCode, int input, ref int? output)
{
	var parameter1 = Read(memory, pointer, 1, GetMode(opCode, 1));
	var parameter2 = Read(memory, pointer, 2, GetMode(opCode, 2));
